  ...
  <div class="bg-white">
    <div class="header-img">
      <div class="container">
        <div class="slider">
          <span>
            <img src="@/assets/icons/arrow-left.png" alt="dwe" />
          </span>
          <span>
            <img src="@/assets/icons/arrow-right.png" alt="ada" />
          </span>
        </div>
    ...
    <div class="container">
      <div class="row mt-2">
        <div class="col-md-6 d-flex elements">
...
<style>
.header-img {
  background-image: url("@/assets/partnership/image1.png");
